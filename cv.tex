...
\begin{itemize}
	...
	\begin{itemize*}
		\item Developed new aspect-based sentiment analysis (ABSA) endpoint\footnote{\url{https://developer.aylien.com/text-api-demo?text=&language=en&tab=absa&domain=airlines}} for four domains; created data collection and training pipeline; implemented semi-supervised convolutional neural networks.
...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item More broadly, I'm interested in learning better (cross-lingual) representations for words and documents, leveraging compositionality not only of natural language, and using conversations for language learning.
	\end{itemize*}
