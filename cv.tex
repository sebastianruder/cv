...
\begin{enumerate}
	...
	\item \textbf{Sebastian Ruder}*, Ryan Cotterell*, Yova Kementchedjhieva, Anders Søgaard. A Discriminative Latent-Variable Model for Bilingual Lexicon Induction. In \textit{Proceedings of EMNLP 2018}, Brussels, Belgium.

	\item Yova Kementchedjhieva, \textbf{Sebastian Ruder}, Ryan Cotterell, Anders Søgaard (2018). Generalizing Procrustes Analysis for Better Bilingual Dictionary Induction. In \textit{Proceedings of CoNLL 2018}, Brussels, Belgium.
