...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item My current work focuses on developing efficient methods to adapt text classification systems to new domains and languages.
	\end{itemize*}
...
\begin{itemize}
	...
	\headerrow
		...
		{\emph{10/2015 -- Present}}
	\begin{itemize*}
		\item Research in domain adaptation and transfer learning of ML and deep learning techniques with applications to cross-lingual sentiment analysis, question answering, and dialogue modeling.
	\end{itemize*}
...
\begin{itemize}
	...
	\item Sebastian Ruder, Parsa Ghaffari, John G. Breslin (2016). Knowledge Adaptation: Teaching to Adapt. \textit{Under review as a conference paper at ICLR 2017.}
