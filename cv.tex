...
\begin{enumerate}
	...
	\item Jeremy Howard, \textbf{Sebastian Ruder} (2018). Universal Language Model Fine-tuning for Text Classification. In \textit{Proceedings of ACL 2018}, Melbourne, Australia.

	\item Anders Søgaard, \textbf{Sebastian Ruder}, Ivan Vulić (2018). On the Limitations of Unsupervised Bilingual Dictionary Induction. In \textit{Proceedings of ACL 2018}, Melbourne, Australia.
